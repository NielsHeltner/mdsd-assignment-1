...
/**
 * Contains functionality for interacting with the meta model and simulating
 * network data from a client
 *
 * @author Niels
 */
public class MetaModelTester {
    ...
    /**
     * Simulates network data for communicating with a microservice over a
     * network
     *
