...
/**
 * Utility methods for working with http in Java, 
 * and 'serializing' / 'de-serializing' a map of parameters.
 * @author Niels
 *
 */
public class HttpUtil {
	...
	/**
	 * Converts a map of parameters (pairing parameter names with parameter values)
	 * to a String of the format 'parameterName=parameterValue', where each pair
	 * is separated with an '&'
	 * @param parameters
	 * @return
	 */
	...
	/**
	 * Converts a String of parameters of the format 'parameterName=parameterValue', 
	 * where each pair is separated with an '&', to a map where the key is
	...
	/**
	 * Parses and returns the body of an HttpMessage (either request or response)
	 * as a String. If no body is present, returns an empty String ""
	 * @param message
	 * @return
	 */
	...
	public void sendResponse(Socket clientSocket, Object content) throws IOException {
		new RawHttp().parseResponse("HTTP/1.1 200 OK\r\n" + "Content-Type: text/plain\r\n")
